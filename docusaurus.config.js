    ...
    [
      ...
      ({
        docs: {
          ...
          rehypePlugins: [[require('rehype-raw'), { passThrough: ['mdxJsxFlowElement', 'mdxJsxTextElement', 'mdxjsEsm'] }], [require('./plugins/docusaurus-qworld-plugin/rehype-qworld-diagram.js'), { baseUrl: BASE_URL }]],
        },
        blog: {
